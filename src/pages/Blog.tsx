...
const featuredPost = {
  ...
  excerpt:
    "פרשת וארא פותחת בקריאה עמוקה לפתיחת הלב, להקשבה פנימית ולתנועה שמתחילה במקום הרגיש ביותר. במאמר הזה אני מתבוננת על הקשר בין הטקסט המקראי לבין תהליכים פסיכולוגיים של שינוי, ועל הרגעים שבהם הלב מבקש להיפתח ולנוע.",
