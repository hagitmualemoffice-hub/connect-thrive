...
const featuredPost = {
  ...
  excerpt:
    "על רגעים של כאב ומה אפשר לעשות איתו. אם היה לך רגע כזה השבוע שהוציא אותך מאיזון - שיחה אחת שנכנסה ללב, רגש שלא הצלחת להחזיק, רגע של קנאה, ייאוש, עצב או כעס שלא כל כך אהבת לפגוש בעצמך. כמה מחשבות על מה אפשר לעשות עם כאב, ואיך להישאר רגע בתוכו בלי לברוח.",
