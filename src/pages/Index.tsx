...
import { Sprout, Lightbulb, Users, Heart } from "lucide-react";
import { z } from "zod";
...
const lectureCards: LectureCard[] = [
  {
    ...
    desc: "בהרצאה נבחן כיצד ניתן לפתח מערכת יחסים מיטיבה עם המציאות המשתנה, למצוא עוגנים של כוח ומשמעות, ולבנות חיים שיש בהם יציבות פנימית גם בתקופות של חוסר ודאות.\n\nדרך סיפורים, רעיונות פסיכולוגיים והתבוננות בחוויות החיים, נעסוק בשאלה כיצד אפשר להמשיך לצמוח, לבחור ולהרגיש חיים – גם כשהגלים גבוהים וגם כשהים שקט. 🌊",
        ...
        <div className="md:hidden absolute top-[86%] left-0 right-0 z-20 -translate-y-1/4 -mt-[15px] px-[30px]">
          <div className="relative bg-white/95 backdrop-blur-sm rounded-xl px-4 pt-8 pb-8 md:pt-4 md:pb-4 shadow-md mx-auto">
            <p className="text-foreground text-[15px] font-light leading-relaxed text-center mb-3">
              <strong className="text-[15px] font-light">הרצאות, תוכן ועשייה חברתית סביב</strong>
              <br />
              <strong className="text-[15px] font-light">התמודדות, משמעות ותנועה בחיים</strong>
              <br />
        ...
        <div className="w-full md:w-[min(1000px,72%)] mx-auto"><div className="w-full md:w-[min(720px,76%)] mr-0 text-right">
          ...
          >
            <div className="space-y-4 md:space-y-6">
              <p>
                אני פסיכולוגית קלינית בהתמחות, מרצה ויזמת חברתית.
              </p>
              <p>
                אני מלווה תהליכים רגשיים, מעבירה הרצאות וסדנאות, ומובילה קבוצות ויוזמות סביב עולמות של נפש, נשים והתמודדות עם אתגרי החיים.
              </p>
              <p>
                באתר תמצאי תכנים, כלים והסתכלות פסיכולוגית על נושאים כמו התמודדות, תפקוד בתוך משבר, חוסן נפשי, נשיות, קשר לעצמנו, משמעות, קבלת החלטות ותקופות שינוי.
              </p>
            </div>
          </ExpandableText>
            ...
            {[
              {
                ...
                body: (
                  <>
                    הרצאות פסיכולוגיות בגובה העיניים על התמודדות, קבלת החלטות וחוסן.
                    <br />
                    <br />
                    מפגש שמחבר בין מחשבה עמוקה לכלים שאפשר לקחת לחיים.
                    <br />
                    <br />
                    <br />
                  </>
              ...
              },
              {
                ...
                body: (
                  <>
                    כתיבה על החיים כפי שהם - דרך הסתכלות פסיכולוגית ואנושית.
                    <br />
                    <br />
                    מחשבות ורעיונות על נפש, משמעות והתמודדות.
                  </>
                ),
                Icon: Sprout,
              ...
              },
              {
                ...
                body: (
                  <>
                    יוזמות שנולדו מתוך צרכים אמיתיים בשטח.
                    <br />
                    <br />
                    חיבור בין הבנה נפשית, קהילה ויצירת שינוי.
                  </>
                ),
                Icon: Heart,
                cta: { label: "הפרויקטים שלי", to: "/projects" },
              },
            ].map((card, idx) => {
      ...
      <section id="lectures" className="w-full pt-2 pb-12 md:py-20 px-[30px] md:px-6">
        ...
        <div className="w-full md:w-[min(1000px,72%)] mx-auto" dir="rtl">
          ...
          <div className="mt-8 hidden md:flex justify-center">
            <Link
              to="/lectures"
              className="px-8 py-3.5 rounded-full bg-primary text-primary-foreground hover:bg-[hsl(var(--primary-glow))] transition-all duration-500 shadow-md shadow-primary/20 text-base tracking-wide"
            >
              לכל ההרצאות
            </Link>
          </div>
        ...
        <div className="w-full md:w-[min(1000px,72%)] mx-auto" dir="rtl">
          <div className="text-right mb-6 md:mb-12 px-1 md:px-0">
            ...
            <p className="text-foreground/80 text-sm md:text-lg font-light leading-relaxed">
              פודקאסט שנולד מתוך עבודה עם תהליך מורכב של שימור פוריות ומתרחב לשאלות על התמודדות, בחירה וחיים בתוך מציאות שיש בה מורכבות וחוסר ודאות. הצצה לדרך אחרת לחיות בתוך זה.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-[min(1100px,82%)] mx-auto" dir="rtl">
          <div className="bg-card rounded-2xl md:rounded-[40px] shadow-[0_20px_60px_-20px_hsl(0_0%_0%_/_0.12)] px-6 md:px-20 py-10 md:py-16">
            <div className="grid md:grid-cols-[auto_1fr] gap-6 md:gap-12 items-start">
              {/* Right side: heading */}
              <div className="text-right md:border-l md:border-border md:pl-12 md:min-w-[220px]">
              ...
              <div className="space-y-5 text-foreground/80 leading-loose text-sm md:text-base text-right">
                <p>
                  אני חגית מועלם, פסיכולוגית בהתמחות קלינית ומייסדת עמותת ליבי. בוגרת תואר שני בפסיכולוגיה קלינית מהאוניברסיטה העברית, וכיום מתמחה בכללית..
                </p>
                <p>
