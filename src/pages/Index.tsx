        ...
        <div className="w-full md:w-[min(1000px,72%)] mx-auto"><div className="w-full md:w-[min(720px,76%)] mr-0 text-right">
          ...
          >
            <div className="space-y-4 md:space-y-6">
              ...
              <p>
                באתר תמצאי תכנים, כלים והסתכלות פסיכולוגית על נושאים כמו דיכאון וחרדה, תפקוד בתוך משבר, רווקות, שימור פוריות, חוסן נפשי, נשיות, קשר לעצמנו,
                <br />
                משמעות וצמיחה.
              </p>
              <p>
                המטרה שלי היא לקחת רעיונות פסיכולוגיים עמוקים - ולהפוך אותם למשהו שאפשר להבין, להרגיש, ולפגוש בחיים עצמם.
              </p>
            </div>
          </ExpandableText>
            ...
            {[
              {
                ...
                body: (
                  <>
                    הרצאות בגובה העיניים שמחברות בין פסיכולוגיה, משמעות וחיים עצמם.
                    <br />
                    <br />
                    על התמודדות רגשית, קבלת החלטות, חוסן, רווקות, שימור פוריות, נשיות, תנועה בתוך תקופות מורכבות וחיבור לכיוון אישי.
                    <br />
                    <br />
                    מפגש שמאפשר לעצור, לחשוב, ולהמשיך הלאה עם יותר בהירות וכלים.
                  </>
                ),
                Icon: Lightbulb,
              ...
              },
              {
                ...
                body: (
                  <>
                    מרחבים קבוצתיים המבוססים על שיחה, טקסטים והתבוננות משותפת.
                    <br />
                    <br />
                    דרך עבודה קבוצתית וכלים מעולמות הפסיכולוגיה והביבליותרפיה, נוצר מקום לעצור, להבין מה קורה בפנים - ולנוע ממנו החוצה.
                  </>
                ),
                Icon: Users,
              ...
              },
              {
                ...
                body: (
                  <>
                    כתיבה על החיים כפי שהם - דרך הסתכלות פסיכולוגית ולעיתים גם רוחנית־יהודית.
                    <br />
                    <br />
                    מחשבות, כלים ותוכן על נפש, התמודדות, רווקות, נשיות, משמעות וחיים בתוך מציאות מורכבת.
                  </>
                ),
                Icon: Sprout,
              ...
              {
                tag: "עשייה",
                title: "יוזמות חברתיות",
                body: (
                  <>
                    יוזמות שנולדו מתוך מפגש עם צרכים אמיתיים - סביב נשים, קהילה ושימור פוריות.
                    <br />
                    <br />
                    עשייה שמבקשת לחבר בין הבנה נפשית, חיבור אנושי ושינוי בעולם.
                  </>
                ),
                Icon: Heart,
                cta: { label: "לקריאה על היוזמות", to: "/projects" },
              },
            ].map((card, idx) => {
