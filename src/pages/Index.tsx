            ...
            {[
              {
                ...
                body: (
                  <>
                    הרצאות על קבלת החלטות, חיבור לכיוון אישי, יוזמה ותנועה גם בתנאים משתנים.
                    <br />
                    <br />
                    הרצאות שמחברות בין חשיבה עמוקה לבין פעולה - ומאפשר לאנשים ולצוותים לפעול מתוך חיבור פנימי 
                    <br />
                    <br />
                    <br />
                    אם אתם מחפשים מפגש שמאפשר לעצור, לחדד חשיבה ולצאת עם כיוון ותנועה - זו הזמנה להיפגש.
                  </>
                ),
                Icon: Lightbulb,
