...
const lectureCards: LectureCard[] = [
  ...
  },
  {
    ...
    desc: "הרצאה על האתגר האנושי בעידן של AI - כשהקצב מהיר, האפשרויות מתרבות, וההשוואה מתמדת. על חרדה ו-FOMO, ועל התחושה שזה \"לא בשבילי\" - ואיך אפשר להתקרב, לנסות ולהיעזר, לנוע גם בלי בהירות מלאה, ולבנות כיוון בעולם משתנה. הרצאה שמחדדת חשיבה ומאפשרת לצאת עם יותר בהירות ויציבות.",
        ...
        <div className="w-full md:w-[min(1000px,72%)] mx-auto"><div className="w-full md:w-[min(720px,76%)] mr-0 text-right">
          ...
          >
            <div className="space-y-4 md:space-y-6">
              <p>
                זה מרחב לפגוש את החיים כפי שהם
                <br />
                בלי לעקוף, בלי למהר לפתור.
              </p>
              <p>
