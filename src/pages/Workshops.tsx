...
const flow = [
  ...
  },
  {
    n: "02",
    title: "מפגש עם הטקסט",
    desc: "קוראים יחד טקסט שנבחר בקפידה - שיר, סיפור קצר, קטע הגותי או מקור יהודי. הטקסט הוא שער.",
  },
  {
    n: "03",
    title: "תהודה אישית",
  ...
  },
  {
    n: "05",
    title: "תובנה וסגירה",
    desc: "מסכמים את התנועה. מה לוקחים הביתה? איזה זרע נשתל? איך ממשיכים מכאן?",
  },
];
...
const buildSteps = [
  {
    title: "שיחת היכרות",
    desc: "אנחנו נפגשים. מדברים על הקבוצה שלכם, על השלב שבו אתם נמצאים, ועל מה שהייתם רוצים שהמפגש יעורר.",
  },
  {
    title: "מיפוי הצורך",
  ...
  {
    title: "בחירת טקסטים",
    desc: "אני בוחרת טקסטים שמדברים בדיוק למקום הזה. ספרות, שירה, פסיכולוגיה, מקורות יהודיים - או שילוב.",
  },
  {
    title: "תפירת מבנה",
        ...
        <div className="relative z-10 h-full flex items-end pb-12 md:pb-20 px-[30px] md:px-6">
          <div className="w-full md:w-[min(1100px,82%)] mx-auto text-right">
            ...
            <p className="text-foreground/75 text-base md:text-xl font-light max-w-2xl leading-relaxed">
              סדנאות הנבנות במיוחד עבור הקבוצה שלכם - מפגש עמוק שבו ספרות, שירה והגות פוגשים את החיים שלנו.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-16 md:py-28 px-[30px] md:px-6">
        <div className="w-full md:w-[min(900px,82%)] mx-auto text-center">
          ...
          <p className="text-foreground/75 text-base md:text-lg font-light leading-relaxed max-w-2xl mx-auto">
            הטקסט הוא רק תירוץ נפלא - כדי לדבר על מה שבאמת חשוב.
