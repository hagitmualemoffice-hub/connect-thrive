    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex flex-col md:flex-row overflow-y-auto">
          {/* Image side */}
          <div className="md:w-5/12 relative min-h-[200px] md:min-h-[620px] bg-muted overflow-hidden">
            <img
              src={hostImage}
          ...
          {/* Content side */}
          <div className="md:w-7/12 px-8 py-10 md:px-12 md:py-14 flex flex-col">
